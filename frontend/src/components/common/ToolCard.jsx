...
export default function ToolCard({
  ...
  return (
    <div className="bg-[#12181A] rounded-xl shadow-lg p-6 border border-[#313B3D] hover:border-[#00CCFF] transition-all cursor-pointer">
      ...
      <p className="text-sm mt-2 text-[#778A8F]">{description}</p>
